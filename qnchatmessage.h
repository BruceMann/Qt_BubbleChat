...
public:
    ...
    void messageSetting(User_Type userType,Content_Type contentType,QString content,QString time=QString());
    void setTextSuccess();
    void setText(QString text, QString time, QSize allSize, User_Type userType);

    QSize getRealString(QString src);
    QSize fontRect(QString str, Content_Type contentType);

     void setImagePath(QString path);

     bool getIsSending(){return m_isSending;}
